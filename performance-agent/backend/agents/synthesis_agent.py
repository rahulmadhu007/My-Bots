"""AI synthesis agent — cross-references specialist findings via Claude."""
...
def synthesise(
    ...
    """Synthesise specialist results with Claude; fall back if API fails."""
    ...
    try:
        ...
        print(f"[synthesis_agent] Claude synthesis complete for {employee_name}")
        return result
